...
*/
-- DropForeignKey
ALTER TABLE "public"."Program" DROP CONSTRAINT "Program_createdBy_fkey";

-- DropForeignKey
ALTER TABLE "public"."WorkoutTemplate" DROP CONSTRAINT "WorkoutTemplate_createdBy_fkey";
...
CREATE TABLE "public"."User" (
    ...
    "weaknesses" "public"."BodyPart"[],
    "strengths" "public"."BodyPart"[],

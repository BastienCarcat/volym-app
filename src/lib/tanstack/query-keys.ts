export const queryKeys = {
  ...
  programs: {
    ...
    schedules: (programId: string) => [...queryKeys.programs.detail(programId), 'schedules'] as const,
  },
  ...
  workouts: {
    ...
    exercises: (workoutId: string) => [...queryKeys.workouts.detail(workoutId), 'exercises'] as const,
  },
  ...
  exercises: {
    ...
    list: (filters: Record<string, any>) => [...queryKeys.exercises.lists(), { filters }] as const,
    details: () => [...queryKeys.exercises.all, 'detail'] as const,
    detail: (id: string) => [...queryKeys.exercises.details(), id] as const,
    sets: (exerciseId: string) => [...queryKeys.exercises.detail(exerciseId), 'sets'] as const,
  },
} as const
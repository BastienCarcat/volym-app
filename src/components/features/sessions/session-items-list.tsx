...
import { SetType, SessionItemType } from "@/generated/prisma";
              ...
              return (
                ...
                >
                  ...
                  {itemValue.circuit.circuitItems?.map(
                    (circuitItem: any, circuitItemIndex: number) => {
                      if (
                        circuitItem.type === "Exercise" &&
                        circuitItem.exercise
                      ) {
                        return (
                          <SessionExerciseItem
                            key={
                              circuitItem.id || `circuit-ex-${circuitItemIndex}`
                            }
                            ...
                            onRemove={() => {
                              // TODO: Remove CircuitItem (needs nested field array)
                            }}
                            inCircuit
                          />
                        );
